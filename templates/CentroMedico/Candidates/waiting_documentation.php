...
<div class="mx-auto mt-5 col-12">
	<div class="col-12 title-section">
		<h4>Lista de Aspirantes con Estudios Pendientes</h4>
	</div>
	<div class="results">
		<p class="title-results">Aspirantes</p>
		<div class="mx-auto form-group row col-lg-12 col-md-12">
			<?= $this->Form->create($candidatesWithDocumentation, ['type' => 'GET', 'class' => 'col-lg-12 col-md-12 row']) ?>
		...
		<table class="table table-bordered" id="tabla_actualizaciones">
			...
			<tbody>
			<?php foreach ($candidatesWithDocumentation as $appoitment): ?>
				<tr>
