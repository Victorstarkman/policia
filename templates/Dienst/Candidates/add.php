...
<div class="mx-auto mt-5 col-12">
    ...
    <div class="results">
        <div class="container mx-auto row">
            ...
            <div class="pt-0 col-lg-4 col-sm-12">
                <div class="form-group">
                   <?= $this->Form->control('cuil', ['label'=> 'DNI *', 'class' => 'form-control form-control-blue m-0 col-12']); ?>
                </div>
            </div>
            <div class="pt-0 col-lg-4 col-sm-12">
                <div class="form-group">
            ...
            <div class="mx-auto form-group row col-lg-12 col-md-12">
                <div class="pl-0 col-12">
                    <button type="submit" id="guardar" class="btn btn-outline-primary col-12" name="guardar"><i class="far fa-save"></i> Guardar y Asignar turno</button>
                </div>
            </div>
	        <?= $this->Form->end() ?>
        </div>
