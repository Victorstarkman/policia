...
?>
	...
	<div class="mx-auto mt-5 col-12">
		<div class="col-12 title-section">
			<h4>Modificacion de fecha</h4>
		</div>
		<div class="results">
			<div class="container mx-auto row">
				<div class="col-12">
					<p class="title-results">Formulario de modificación de fecha<br/><small>Los campos indicados con&nbsp;<span style="color:red">*</span>  son de llenado obligatorio</small></p>
				</div>
				<?= $this->Flash->render() ?>
				<div class="alert alert-info col-lg-12 text-center msg" role="alert" style="display: none;"></div>
				<?= $this->Form->create($lastAppointment, ['class' => 'col-lg-12 col-md-12 row']) ?>
				...
				<div class="mx-auto form-group row col-lg-6 col-md-12">
					<div class="pl-0 col-12">
						<a href="<?= $this->Url->build(  DS . strtolower($this->request->getParam('prefix')) . '/preocupacionales/ver/' . $lastAppointment->candidate_id, ['fullBase' => true]); ?>" class="btn btn-outline-primary col-12"><i class="far fa-arrow"></i> Volver</a>
					</div>
				</div>
				<div class="mx-auto form-group row col-lg-6 col-md-12">
					<div class="pl-0 col-12">
						<button type="submit" id="guardar" class="btn btn-outline-primary col-12" name="guardar"><i class="far fa-save"></i> Modificar turno</button>
					</div>
				</div>
				<?= $this->Form->end() ?>
			</div>
